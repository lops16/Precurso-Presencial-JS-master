...
let objetocannot = randomObject.them.speed.past.program.grade.addition.whose.national.cannot;

let objetoBoard = randomObject.them.speed.past.program.grade.addition.whose.national.cannot.board;
console.log(objetoBoard);

objetocannot.name= prompt("Añade un nombre");

let objetoBoard2 = randomObject.them.speed.past.program.grade.addition.whose.national.cannot.name;
console.log(objetoBoard2)
