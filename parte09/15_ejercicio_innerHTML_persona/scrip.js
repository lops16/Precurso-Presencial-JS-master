personas = {
    ...
    let data = prompt("Introduce un nombre");

    if (personas[data]) {
        let ficha = personas[data];
        
        document.querySelector("body").innerHTML = `
            <div style="display: flex; justify-content: center; align-items: center; margin: auto; height: 100vh;">
                <div id="main" style="background-color: ${ficha.eyeColor}; padding: 2rem;">
                    <img src="${ficha.picture}" alt="Persona">
                    <h1 id="titulo">${ficha.name}</h1>
                    <p>${ficha.age}</p>
                    <p>${ficha.email}</p>
                    <p><${ficha.address}/p>
                </div>
    ...
    console.log("No tenemos datos de esa persona")
}