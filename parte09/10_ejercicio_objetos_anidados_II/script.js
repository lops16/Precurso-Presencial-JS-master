...
let tufecha = prompt("Introduce tu fecha de nacimiento");

let tunombre = prompt("Introduce tu nombre");

let tuapellido = prompt("Introduce tu apellido");

let subnombre = tunombre.substring(0,1);

let subapellido = tuapellido.substring(tuapellido.length -1);

let subfecha = tufecha.substring(tufecha.length -1);

let nombreheroe = letraNombre[subnombre].masculino + " " + letraApellido[subapellido].masculino + " " + fechaNacimiento[subfecha].masculino;
